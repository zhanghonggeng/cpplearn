...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "v2.4.9"
  WORKING_DIRECTORY "E:/github/c++/cpplearn/project/CodingInterviewChinese2/cmake-build-debug/_deps/doctest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/github/c++/cpplearn/project/CodingInterviewChinese2/cmake-build-debug/_deps/doctest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/github/c++/cpplearn/project/CodingInterviewChinese2/cmake-build-debug/_deps/doctest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
